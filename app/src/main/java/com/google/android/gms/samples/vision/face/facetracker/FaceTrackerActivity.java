...
import static com.google.android.gms.samples.vision.face.facetracker.FaceApplication.mSpeech;
...
public final class FaceTrackerActivity extends AppCompatActivity {
    ...
    private void initView() {
        faceOverlay = (GraphicOverlay) findViewById(R.id.faceOverlay);
    ...
    private class GraphicFaceTracker extends Tracker<Face> {
        ...
        public void onNewItem(int faceId, Face item) {
            ...
            mSpeech.speak(String.valueOf(faceId), TextToSpeech.QUEUE_FLUSH, null);
        }
